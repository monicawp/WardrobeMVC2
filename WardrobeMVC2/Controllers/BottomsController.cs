...
namespace WardrobeMVC2.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomsID,Photo,Name,Type,Color,Occasion,Season")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,Photo,Name,Type,Color,Occasion,Season")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
